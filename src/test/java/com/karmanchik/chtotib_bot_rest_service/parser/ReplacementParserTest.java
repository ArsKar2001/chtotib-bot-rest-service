...
class ReplacementParserTest {
    ...
    private static final File FILE_4 = new File("C:\\Users\\arsen\\YandexDisk\\Учеба\\Дипом\\З_А_М_Е_Н_А_на_среду_7_апреля_неделя_нижняя_doc.docx");

    @Test
    void name() {
        ReplacementParser parser = new ReplacementParser();
        System.out.println(parser.getDateFromFileName(FILE_4.getName()));
    }
